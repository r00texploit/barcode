...
class Showproducts extends StatefulWidget {
  ...
  @override
  State<Showproducts> createState() => _ShowUserState();
}

class _ShowUserState extends State<Showproducts> {
  @override
                              ...
                              Row(
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      "products name: ${snapshot.data!.docs[index]['products_name']}",
                              ...
                              Row(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      "product price: ${snapshot.data!.docs[index]['price']}",
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                              ...
                              Row(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      "product barcode: ${snapshot.data!.docs[index]['barcode']}",
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                ...
                                child: CustomTextButton(
                                    ...
                                    ontap: () async {
                                      ...
                                      try {
                                        ...
                                        setState(() {
                                          Get.back();
                                          showbar('delete products', 'subtitle',
                                              'products deleted', true);
                                        });
                                      } catch (e) {
                                        setState(() {
                                          Get.back();
                                          showbar('delete product', 'subtitle',
                                              e.toString(), false);
                                        });
                                      }
                                    },
